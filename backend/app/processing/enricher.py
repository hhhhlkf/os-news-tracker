...
- importance: 从 [高, 中, 低] 选一个。
  ...
  3. 相关性与维护价值
     - 与 OS maintainer 的核心关注高度相关，能明显支撑技术探讨、路线判断、选型、升级或维护计划：3分
...
- 如果内容主要讲 CPU、GPU、NPU、芯片、服务器、存储等硬件产品、规格、跑分或硬件架构，而没有明确说明对操作系统、内核、驱动、发行版、设备支持、资源调度、兼容性或维护决策的直接影响，必须 should_store=false。
